...
class Contrato extends Model
{
     ...
     */
    protected $fillable = [
        'casa_id','unidade_id','numero','aditivado','ano','tipo','total', 'arquivo', 'empresa_id','data_inicio','data_fim','origem','encerramento','valor_origem','comentario_origem','status','comentario'
    ];
